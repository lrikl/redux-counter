...
export const store = configureStore({
  ...
  preloadedState, // configureStore знає, що якщо їй передали preloadedState (зарезервоване слово), то його потрібно використовувати для ініціалізації відповідних частин стану, віддаючи йому перевагу над initialState з createSlice
